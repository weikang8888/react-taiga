          ...
          <div className="row">
            ...
            <div className="col-lg-12">
              <p className="service-benefit-column">
                <div className="tick-orange"></div>A well-maintained suspension
                system ensures a smoother and more comfortable driving
                experience, even on rough or bumpy roads.
              </p>
              <p className="service-benefit-column">
                <div className="tick-orange"></div>
                Proper suspension service improves the vehicle's handling and
                stability, allowing for better control during turns and
                maneuvers.
              </p>
              <p className="service-benefit-column">
                <div className="tick-orange"></div>A properly serviced
                suspension system helps distribute the vehicle's weight evenly,
                reducing uneven tire wear and extending tire life.
              </p>
              <p className="service-benefit-column">
                <div className="tick-orange"></div>Maintaining a healthy
                suspension system enhances overall vehicle safety by providing
                better traction, stability, and control, reducing the risk of
                accidents.
              </p>
              <p className="service-benefit-column">
                <div className="tick-orange"></div> Well-maintained suspension
                components contribute to the vehicle's overall stability,
                reducing body roll and enhancing the driving experience.
              </p>
            </div>
          </div>
        </div>
